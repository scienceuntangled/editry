...
If you don't have `ffmpeg` on your system, you will also need this. On Windows or Linux you can use:
```{r eval = FALSE}
er_install_ffmpeg()
```

On other platforms (e.g. Mac) you will currently need to install `ffmpeg` yourself.
